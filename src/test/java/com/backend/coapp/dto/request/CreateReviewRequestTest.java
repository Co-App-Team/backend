...
class CreateReviewRequestTest {
  ...
  @Test
  void validateRequest_whenValidRequestWithoutComment_expectNoException() {
    CreateReviewRequest request = new CreateReviewRequest(5, null, "Developer", "Summer", 2024);
    assertDoesNotThrow(request::validateRequest);
  }

  @Test
  void validateRequest_whenRatingNull_expectException() {
    CreateReviewRequest request =
  ...
  @Test
  void validateRequest_whenJobTitleNull_expectException() {
    CreateReviewRequest request = new CreateReviewRequest(5, "Great", null, "Summer", 2024);
    assertThrows(InvalidRequestException.class, request::validateRequest);
  }

  @Test
  void validateRequest_whenJobTitleBlank_expectException() {
    CreateReviewRequest request = new CreateReviewRequest(5, "Great", "   ", "Summer", 2024);
    assertThrows(InvalidRequestException.class, request::validateRequest);
  }

  @Test
  void validateRequest_whenSeasonNull_expectException() {
  ...
  @Test
  void validateRequest_whenYearNull_expectException() {
  ...
  @Test
  void validateRequest_whenSeasonBlank_expectException() {
