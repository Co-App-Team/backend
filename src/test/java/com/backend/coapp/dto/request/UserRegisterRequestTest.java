...
public class UserRegisterRequestTest {
    ...
    public void validateRequest_whenInvalidPassword_expectException(){
        UserRegisterRequest requestPasswordNull = new UserRegisterRequest("foo@mail.com",null,"foo","woof");
        assertThrows(InvalidRequestException.class,requestPasswordNull::validateRequest);

        UserRegisterRequest requestPasswordBlank = new UserRegisterRequest("foo@mail.com","","foo","woof");
    ...
    public void validateRequest_whenInvalidFirstname_expectException(){
        UserRegisterRequest requestFirstnameNull = new UserRegisterRequest("foo@mail.com","123",null,"woof");
        assertThrows(InvalidRequestException.class,requestFirstnameNull::validateRequest);

        UserRegisterRequest requestFirstnameBlank = new UserRegisterRequest("foo@mail.com","123","","woof");
    ...
    public void validateRequest_whenInvalidLastname_expectException(){
        UserRegisterRequest requestLastnameNull = new UserRegisterRequest("foo@mail.com","123","foo",null);
        assertThrows(InvalidRequestException.class,requestLastnameNull::validateRequest);

        UserRegisterRequest requestLastnameBlank = new UserRegisterRequest("foo@mail.com","123","foo","");
