...
public class UpdateReviewRequestTest {
  ...
  @Test
  public void validateRequest_whenAllFieldsProvided_expectNoException() {
    UpdateReviewRequest request = new UpdateReviewRequest(4, "Updated", "Engineer", "Fall", 2023);
    assertDoesNotThrow(request::validateRequest);
  }

  @Test
  public void validateRequest_whenOnlyRatingProvided_expectNoException() {
    UpdateReviewRequest request = new UpdateReviewRequest(4, null, null, null, null);
    assertDoesNotThrow(request::validateRequest);
  }

  @Test
  public void validateRequest_whenOnlyCommentProvided_expectNoException() {
    UpdateReviewRequest request = new UpdateReviewRequest(null, "Updated", null, null, null);
    assertDoesNotThrow(request::validateRequest);
  }

  @Test
  public void validateRequest_whenNoFieldsProvided_expectException() {
